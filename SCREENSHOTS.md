...
All screenshots from the live production app (mobile PWA).
...
### Research Hub — Leaderboard, Free Agents & Compare

| Leaderboard (Redis-cached rankings) | Free Agents (waiver hold badges) | Player Compare (side-by-side) |
|--------------------------------------|----------------------------------|-------------------------------|
