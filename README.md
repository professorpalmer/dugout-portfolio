...
- **MLFlow-style AI observability** — admin-gated audit layer summarizes bot decision volume, CLV, unresolved audit backlog, cohort-demo collection, gear-economy behavior, personality drift, and outlier decisions across short/medium/all-time windows. Designed to surface strategy regressions, emergent edges, and noisy learning signals before they become product problems
...
| Waiver processing | Daily (early-morning ET) | Per-league waiver claims + post-waiver bot lineup optimize |
