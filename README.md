...
| **Admin routes** | High-impact endpoints require an admin API key header; missing key → **404** (not 403) to prevent discovery |
...
| **Admin key for dangerous routes** | Maintenance without exposing "hidden" power endpoints; missing-key responses return 404 rather than 403 to prevent discovery |
